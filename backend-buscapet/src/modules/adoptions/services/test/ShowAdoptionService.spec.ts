...
import ShowAdoptionService from '../ShowAdoptionService';
...
let showAdoption: ShowAdoptionService;
let adoption: IAdoption;

describe('ShowAdoption', () => {
  beforeEach(async () => {
    ...
    showAdoption = new ShowAdoptionService(fakeAdoptionsRepository);
  ...
  it('Deveria ser capaz de mostrar uma adoção pelo id', async () => {
  ...
  it('Não deveria ser capaz de mostrar uma adoção com id inválido', async () => {
    expect(
