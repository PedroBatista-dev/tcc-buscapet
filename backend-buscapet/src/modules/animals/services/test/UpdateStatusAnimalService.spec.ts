...
describe('UpdateStatusAnimal', () => {
  ...
  it('Deve ser capaz de atualizar o status de um animal pelo id', async () => {
  ...
  it('Não deve ser capaz de atualizar o status de um animal com id inválido', async () => {
    expect(
  ...
  it('Não deve ser capaz de atualizar o status de um animal com status que o animal já possui', async () => {
    expect(
      updateStatusAnimal.execute({
        id: animal.id,
        status: 'Criado',
